...
![open_rate](images/open_rate_bar.png)

### All Emails
- When we average our data we see that the combined open rate for emails A,B,C,D
is 25%. 

![open_rate_all](images/open_rate_all.png)

![open_rate_combined](images/open_rate_combined.png)
